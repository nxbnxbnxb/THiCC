...
#       if u CAN'T do this, THEN rename /home/ubuntu/ to a single variable and use it everywhere, renaming it /home/n/ when necessary

upload_dir=/home/ubuntu/x/p/fresh____as_of_Dec_12_2018/vr_mall____fresh___Dec_12_2018/src/web/upload_img_flask/customer_imgs/ # /home/ubuntu/  /home/n/ # TODO: rename the user on the AWS EC instance.  (AND every new AWS instance you make)
