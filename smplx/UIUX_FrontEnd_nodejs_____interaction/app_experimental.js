...
function wait(req, res, next){
  var SMPLX_time=100000; // 100 seconds   at LEAST.
  setTimeout((function() { res.send(items);}), SMPLX_time); // "2000"  ==  2 seconds
  next();
}
...
app.post('/upload', multer.single('file'), (req, res, next), wait => {
  /*
   *===================================================================================================
   *    BEGIN DOCSTRING:
   *===================================================================================================
